...
// Mengubah endpoint ini untuk menunjukkan InstanceId

app.MapGet("/", ([FromServices] InstanceService instanceService) =>
    $"Welcome to ProductService! Instance ID: {instanceService.InstanceId}")
    .WithName("Welcome");

app.MapGet(app.Environment.IsDevelopment() ? "/hello-dev" : "/hello", () => "Hello World!")
   .WithName("HelloWorld");
